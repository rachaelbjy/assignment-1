...
<head>
    ...
    <meta name="description" content="Detailed technical report of CSS3 and HTML5 enhancements used in Cacti-Succulent Kuching.">
    <meta name="keywords" content="enhancements, web development, html5, css3, animations, report">
    ...
    <main class="content-wrapper">
        ...
        <div class="enhancements-list">
            ...
            <article class="enhancement-row">
                <figure class="enhancement-figure">
                    <video class="enhancement-video" preload="auto" autoplay loop muted playsinline>
                        <source src="videos/recording-cactus-party.mp4" type="video/mp4">
            ...
            <article class="enhancement-row">
                <figure class="enhancement-figure">
                    <video class="enhancement-video" preload="auto" autoplay loop muted playsinline>
                        <source src="videos/recording-typewriter.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </figure>
                <div class="enhancement-text">
            ...
            <article class="enhancement-row">
                <figure class="enhancement-figure">
                    <video class="enhancement-video" preload="auto" autoplay loop muted playsinline>
                        <source src="videos/recording-dark-mode.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </figure>
                <div class="enhancement-text">
            ...
            <article class="enhancement-row">
                <figure class="enhancement-figure">
                    <video class="enhancement-video" preload="auto" autoplay loop muted playsinline>
                        <source src="videos/recording-button-shine.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </figure>
                <div class="enhancement-text">
            ...
            <article class="enhancement-row">
                <figure class="enhancement-figure">
                    <video class="enhancement-video" preload="auto" autoplay loop muted playsinline>
                        <source src="videos/recording-cascade-grid.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </figure>
                <div class="enhancement-text">
            ...
            <article class="enhancement-row">
                <figure class="enhancement-figure">
                    <video class="enhancement-video" preload="auto" autoplay loop muted playsinline>
                        <source src="videos/recording-smooth-page.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </figure>
                <div class="enhancement-text">
            ...
            <article class="enhancement-row">
                <figure class="enhancement-figure">
                    <video class="enhancement-video" preload="auto" autoplay loop muted playsinline>
                        <source src="videos/recording-back-to-top.mp4" type="video/mp4">
                        Your browser does not support the video tag.
                    </video>
                </figure>
                <div class="enhancement-text">
